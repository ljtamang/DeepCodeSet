...
### Logical Steps
A logical step is concise sentence  that describes at avery high level the functionality of a chunk of code with respect to the overall goal of the code, i.e., to the real-world problem it solves. Here, the chunk of the code referes to the logically seperable block of code with subgoals. All logical steps together forms meaningful, higher-level steps in the overall solution/algorithm implemented by the code as whole.
