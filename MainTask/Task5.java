...
public class Average {
    public static void main(String[] args) {
        ...
        * logical_step_details: Initialize an array called numbers with integers whose average is to be calculated. 
        * The data-type of the variable numbers is integer array. The values declared in array numbers are: 4,2,4,5,10.
        ...
        * logical_step_details: Initialize the variable sum and integer variable count with value zero to store the sum of numbers in the array. The datatype of the variable sum is double. The data type of variable counter is integer.
        * question_1: What does the following code block do?
        ...
        * logical_step_details: Iterate through each element of an array to calculate the sum of each elements of array numbers. The value of numbers.length is 5. The for loop executes 5 times. The value of sum at the end of foor lop execution is 25. 
        * question_1: What does the following code block do?
        * answer_1: Iterate through each element of an array to calculate the sum of each elements of array numbers.
        * question_2: What is the value of numbers.length?
        * answer_2: the value of numbers.length is 5.
        * question_3: How many times does the for-loop execute?
        * answer_3: the for loop executes 5 times.
        * question_4: What is the value of sum at the end of foor lop execution?
        * answer_4: The value of sum at the end of foor lop execution is 25.
        */
        ...
        * logical_step_details: Declare a variable average to compute and store the average of numbers. The datatype of the variable average is double. The value of average is 5. The value 5 is printed.
        * question_1: What does the following code block do?
        * answer_1:  Declare a variable average to compute and store the average of numbers.
        ...
        * answer_3: The value of average is 5.
        * question_4: What value is printed?
        * answer_4: The value 5 is printed.
        */
