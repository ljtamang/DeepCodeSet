...
public class GridOfStars {
    public static void main(String[] args) {
         ...
         * logical_step_1: It specifies the size of the grid of stars in terms of height and width measured in the number of stars.
        ...
        for (int row = 0; row < height; row++) {
             ...
             * answer_2: The inner loop runs for a number of iterations given by variable width.
             */
